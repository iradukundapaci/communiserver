...
export class InitialMigration1746729085815 implements MigrationInterface {
  name = "InitialMigration1746729085815";
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "villages" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "name" character varying NOT NULL, "cell_id" uuid NOT NULL, CONSTRAINT "PK_3d9cf7c71c05c7ef684331317bd" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "cells" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "name" character varying NOT NULL, "sector_id" uuid NOT NULL, CONSTRAINT "PK_b9443df02c1a41bc03f264388c8" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "activity_participants" ("activity_id" uuid NOT NULL, "profile_id" uuid NOT NULL, CONSTRAINT "PK_35b9890fa1e4012b6a00929297e" PRIMARY KEY ("activity_id", "profile_id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_9cb6d690439d69efb428151cf0" ON "activity_participants" ("activity_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_93654dd7a1b2a29f0d769e5b85" ON "activity_participants" ("profile_id") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "houses" ADD CONSTRAINT "FK_1ab89707fa8f556b9ee9ff19c93" FOREIGN KEY ("representative_id") REFERENCES "profiles"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "houses" ADD CONSTRAINT "FK_2f6913f35422a16d01668831eba" FOREIGN KEY ("isibo_id") REFERENCES "isibos"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "profiles" ADD CONSTRAINT "FK_eb7721170ddc5d8fb6677e28723" FOREIGN KEY ("house_id") REFERENCES "houses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "activity_participants" ADD CONSTRAINT "FK_9cb6d690439d69efb428151cf0a" FOREIGN KEY ("activity_id") REFERENCES "activities"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "activity_participants" ADD CONSTRAINT "FK_93654dd7a1b2a29f0d769e5b85b" FOREIGN KEY ("profile_id") REFERENCES "profiles"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "activity_participants" DROP CONSTRAINT "FK_93654dd7a1b2a29f0d769e5b85b"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "profiles" DROP CONSTRAINT "FK_eb7721170ddc5d8fb6677e28723"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "houses" DROP CONSTRAINT "FK_2f6913f35422a16d01668831eba"`,
    );
    await queryRunner.query(
      `ALTER TABLE "houses" DROP CONSTRAINT "FK_1ab89707fa8f556b9ee9ff19c93"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_93654dd7a1b2a29f0d769e5b85"`,
    );
    await queryRunner.query(
